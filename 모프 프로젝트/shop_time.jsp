...
<section class="section1">
    <h1>Run into History<span>가 추천하는 시대별 콘텐츠</span></h1>
    <div class="line"></div>
    <em>*역사적 상황들을 시대별로 모아보았습니다</em>
   
</section>
<section class="content">

 <h4>고대시대<span>고대시대의 삶을 여러분께 소개합니다.</span></h4>
<% 
  ...
  try {
    ...
    String sql1 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proLevel LIKE '구%';";
...
<section class="content">
 ...
 <h4>중세시대<span>중세시대의 삶을 여러분께 소개합니다.</span></h4>
 <%  
   ...
   String sql2 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proLevel LIKE '중세%';";
...
<section class="content">
 ...
 <h4>근대시대<span> 근대시대의 삶을 여러분께 소개합니다.</span></h4>
 <%  

    pstmt.close();
    rs.close();     

    String sql3 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proLevel LIKE '근%';";
