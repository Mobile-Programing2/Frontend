...
<section class="section1">
    <h1>Run into History<span>가 추천하는 레벨별 콘텐츠</span></h1>
    <div class="line"></div>
    <em>*역사적 상황들을 레벨별로 모아보았습니다</em>
   
</section>
<section class="content">

 <h4>초급<span>쉬운 난이도로 구성된 콘텐츠입니다.</span></h4>
<% 
  ...
  try {
    ...
    String sql1 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proGangre LIKE '초%';";
...
<section class="content">
 ...
 <h4>중급<span>보통 난이도로 구성된 콘텐츠입니다.</span></h4>
 <%  
    pstmt.close(); 
    rs.close();    

    
    String sql2 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proGangre LIKE '중%';";
...
<section class="content">
 ...
 <h4>고급<span> 어려운 난이도로 구성된 콘텐츠입니다.</span></h4>
 <%  
    pstmt.close();  
    rs.close();   

    String sql3 = "SELECT proNo, proName, proIntro, proImage, proPrice, proGangre, proTime, proLevel FROM product WHERE proGangre LIKE '고%';";
